    ...
    <div className="min-h-screen bg-white p-4 md:p-10 text-black pt-24 lg:pt-14">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 bg-black text-white px-5 py-3 md:px-8 md:py-4 rounded-full text-[10px] md:text-xs font-black uppercase tracking-[0.2em] hover:bg-[#BA9963] transition-all shadow-xl shadow-black/10 active:scale-95"
        >
